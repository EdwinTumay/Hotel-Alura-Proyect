...
import com.alura.jdbc.controllers.UsuarioController;
...
public class Login extends JFrame {
	...
	public Login() {
		...
		panel_1.setBackground(new Color(240, 243, 244));
		panel_1.setBounds(484, 0, 304, 527);
		panel.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel imgHotel = new JLabel("");
		imgHotel.setBounds(-70, 0, 344, 538);
		panel_1.add(imgHotel);
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/imagenes/hotelimage.png")));
		...
		txtUsuario.setBorder(javax.swing.BorderFactory.createEmptyBorder());// campo texto
		...
		labelTitulo.setForeground(new Color(80, 142, 163));
		...
		txtContrasena.setText("********");
		txtContrasena.setForeground(SystemColor.GRAY);
...
//			}
		...
		lblNewLabel.setForeground(new Color(80, 142, 163));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setFont(new Font("Roboto", Font.PLAIN, 18));
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/imagenes/Hh2.png")));
		lblNewLabel_1.setBounds(65, 35, 88, 99);
