...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		panelMenu.setBackground(new Color(80, 142, 163));
		...
		lblNewLabel_2.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/Hh150px.png")));
		...
		btnRegistro.addMouseListener(new MouseAdapter() {
			...
			public void mouseExited(MouseEvent e) {
				btnRegistro.setBackground(new Color(80, 142, 163));	
			}
			@Override
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/calendar.png")));
		labelRegistro.setForeground(new Color(240, 243, 244));
		labelRegistro.setBounds(18, 11, 215, 34);
		...
		btnBusqueda.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseExited(MouseEvent e) {
				btnBusqueda.setBackground(new Color(80, 142, 163));	
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/search.png")));
		lblBusquedaDeReservas.setBounds(20, 11, 200, 34);
		lblBusquedaDeReservas.setHorizontalAlignment(SwingConstants.LEFT);
		lblBusquedaDeReservas.setForeground(new Color(240, 243, 244));
	    ...
	    lblNewLabel_3.setBounds(312, 439, 295, 27);
	    ...
	    lblNewLabel_3_1.setBounds(312, 477, 375, 27);
	    ...
	    lblNewLabel_3_2.setBounds(312, 515, 295, 27);
