...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHuesped.class.getResource("/imagenes/Hh.png")));
		...
		txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuesped.class.getResource("/imagenes/calendar2.png")));
		...
		lblNumeroReserva.setForeground(SystemColor.BLACK);
...
//		JPanel btnguardar = new JPanel();
		...
		btnguardar.setBounds(723, 560, 122, 44);
		...
		labelGuardar.setForeground(new Color(80, 142, 163));
		...
		panel.setBackground(new Color(80, 142, 163));
		...
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/imagenes/pc.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/imagenes/Hh100px.png")));
